...
const ModalShareDialog = ({ selectedDoc }: { selectedDoc: string }) => {
  ...
  return (
    <>
      <ShareDialogDiv id="share-dialog">
        <Target>
          <ButtonA
            href={`https://www.facebook.com/sharer.php?u=${
              infoSite(locale).urlShare + selectedDoc
            }`}
          ...
          <ButtonA
            href={`https://twitter.com/intent/tweet?url=${
              ...
              infoSite(locale).descriptionShare
            }&hasshtags=data,datastudio`}
          ...
          <ButtonA
            href={`mailto:?subject=${
              infoSite(locale).title
            }&body=${encodeURIComponent(infoSite(locale).bodyMail)}  ${
              infoSite(locale).url + selectedDoc
            }`}
            title="Envoyer le lien par email"
          >
            <svg>
        ...
        <PenUrl id="linkToCopy">{infoSite(locale).url + selectedDoc}</PenUrl>
        <LinkA>
          <CopyLink
            onClick={copyLinkFunc}
            style={{
              border: "none",
              color: `${copied ? "var(--info)" : null}`,
            }}
...
export default ModalShareDialog
